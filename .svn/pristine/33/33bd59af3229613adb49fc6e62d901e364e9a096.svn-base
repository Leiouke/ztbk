            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  <div class="form-group inline-small">
					    <label >刊号：</label>
					    <input type="text" name="qk_no" class="form-control search-items" >
					  </div>
					  <div class="form-group inline-small">
					    <label >刊名：</label>
					  ...
					  <div class="form-group inline-small">
					    <label >是否有财务分类：</label>
					    <select name="has_cw_type" class="form-control dictionary search-items isboolean" >
					    	<option value=""></option>
					    </select>
					  </div>
					  <div class="form-group inline-small">
					    <label >是否团购：</label>
					    <select name="is_tuangou" class="form-control dictionary search-items isboolean" >
					    	<option value=""></option>
					    </select>
					  </div>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function () {
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getQkNoCwtypeMappingManageList",$('#table'));
			});
		 ...
		 function toEdit(qk_no){
			 open_layer_refresh(2,'编辑财务分类','qkNoCwtypeMappingEdit?qk_no=' + qk_no,$table,['620px', '580px'], true);
		 }
		 
		 function renderOperator(value,row,index){
			 //console.log(row);
			 return "<a onclick=\"toEdit('"+row.qk_no+"')\">编辑财务分类</a>";
		 }
	</script>
</html>