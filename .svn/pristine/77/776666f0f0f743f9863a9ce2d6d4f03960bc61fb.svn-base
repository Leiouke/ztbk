...
<html lang="zh-CN">
				            ...
				            <div class="col-xs-12">
					            <div class="row">
					            	   <div class="form-group inline-small not-null">
									    <label >入库类型：</label>
									    <select name="in_type" data-id-start ="03" data-id-end ="03" class="form-control dictionary search-items">
									    </select>
									  </div>
								</div>
								<div class="row">
	...
	$(document).ready(function () {
		...
		//button_click_layer_refresh($add,2,"新增入库单明细",'inBoundItemTempAdd',$table,true,['620px', '580px']);
		
		$('#save').on('click', function () {
			
			if(!has_null($("#form"))){
					ajax_function_ask_and_close("确认新增？","addInBound","post",$('#form').serialize(),'新增成功');
			}
