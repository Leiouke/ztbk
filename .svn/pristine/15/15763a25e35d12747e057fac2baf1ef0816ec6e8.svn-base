...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			initialize_table($table,"getInvoiceEditAgentItemList",${tableHeader},queryParams,"#tableTool",550);
			...
			//var $upload=$("#upload");
			//button_click_windows_end($upload,2,"上传订单明细",'sdItemUpload',false,['750px', '580px'],end_function);
