...
<html lang="zh-CN">
	...
	<script type="text/javascript">			
		...
		load_sum_list_first("${context}/csu/getTableCollectData",{'queryId':'${queryId}', 'report_id': '${param.report_id}', 'dep_org_code': '${param.dep_org_code}'
			, 'account_month': '${param.account_month}', 'unit_code': '${param.unit_code}', 'report_type': '${param.report_type}'});
		$(document).ready(function () {			
			//加载字典数据
			get_dictionary("${context}",null);
			//bootstrap初始化
			initialize_table($table,"getSalesReportItemsList",${tableHeader},queryParams,"#tableTool",600);
