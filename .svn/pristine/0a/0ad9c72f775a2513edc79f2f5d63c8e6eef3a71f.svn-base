...
<html lang="zh-CN">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  ...
					  <div class="form-group inline-small">
					    <label >报刊站点刊号：</label>
						<input type="text" name="dh_mail_code" class="form-control search-items" />
					  </div>
					  <div class="form-group inline-small">
					    <label >代销站点刊号：</label>
						<input type="text" name="dx_mail_code" class="form-control search-items" />
					  </div>
					  <div class="form-group inline-small">
					    <label >刊名：</label>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			//bootstrap初始化
			initialize_table($table,"getFactoryMappingResultManageList",${tableHeader},queryParams,"#tableTool",400);
			$("#search").on('click',function(){
				 var json_data_list=formToJson($("#form_search"));
				 json_data_list['queryId']='${queryId}';
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getFactoryMappingResultManageList",$table);
			});
			...
			//自动搜索填补
			initialize_bsSuggest_yh_factory("${context}");
	     });
	</script>
</html>