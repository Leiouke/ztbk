...
<html lang="zh-CN">
		            ...
		            <div class="ibox-content search-content">
			            ...
			            <div class="col-xs-12">
							...
							<div class="row">
								...
								<div class="form-group inline-small not-null">
								    <label >是否开到明细：</label>
								    <select name="is_item_kp" class="form-control dictionary isboolean search-items" id="is_item_kp">
								    </select>
								</div>
								<div class="form-group inline-small not-null">
								    <label >申请开票金额：</label>
	...
	<script type="text/javascript">
		...
		$('#bank_id').on('change', function () {
			window.location.href='?kp_id=${param.kp_id}&f_id=${param.f_id}&bank_id=' + $('#bank_id').val();
		});
	</script>
</html>