...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			initialize_table($table,"getInvoiceEditItemList",${tableHeader},queryParams,"#tableTool",550);
			...
			//增加条目layer
			var $add=$("#add");
			button_click_layer_refresh($add,2,"引入发票明细",'invoiceItemPull',$table,true,['750px', '580px']);
