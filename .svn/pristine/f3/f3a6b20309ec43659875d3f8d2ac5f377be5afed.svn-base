...
<html lang="zh-CN">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">	
					  ...
					  <div class="form-group inline-middle">
					    <label >批销单号：</label>
					    <input type="text" name="px_id" class="form-control search-items" >
					  </div>
					  ...
					  <div class="form-group input-group inline-middle">
					    <label >结算客户编号：</label>
					    <input type="text" name="settlement_c_id" class="form-control search-items" >
					    <div class="input-group-btn">
	                        <button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown">
	                            <span class="caret"></span>
	                        </button>
					  ...
					  <div class="form-group inline-middle">
					    <label >结算户号(_客户名称)：</label>
					    <input type="text" name="settlement_c_name" class="form-control search-items" disabled>
					  </div>
				 </div>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function () {			
			...
			initialize_bsSuggest_fc_client("${context}", "settlement_c_name", "settlement_c_id");
		...
		$("#batchImport").on('click',function() {
			...
			var item_ids= $.map($table.bootstrapTable('getSelections'), function (row) {
                return {'c_id':row.c_id,'source_no':row.px_id,'real_money':row.real_money,'total_money':row.total_money,'memo':row.memo, 'sales_code': row.sales_code, 'op_code':row.input_code, 'op_date': format_date(row.input_date)};
            });
