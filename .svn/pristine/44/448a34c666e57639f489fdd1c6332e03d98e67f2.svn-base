...
<html lang="zh-CN">
			            ...
			            <div class="col-xs-12">
				            <div class="row">
								  ...
								  <div class="form-group inline-small not-null">
								    <label >开票类型：</label>
								    <select name="kp_type" data-id-list = "3,4" class="form-control dictionary search-items" >
								    </select>
								  </div>
							</div>
							<div class="row">
								<div class="form-group inline-small">
								  ...
								  <div class="form-group inline-small not-null">
								    <label >是否开到明细：</label>
								    <select name="is_item" class="form-control dictionary isboolean search-items" >
								    </select>
								  </div>
								<div class="form-group inline-small">
								    <label >可申请开票金额：</label>
								...
								<div class="form-group inline-small not-null">
								    <label >已申请开票金额：</label>
								    <input type="text" name="claim_kp_money" class="form-control search-items">
								</div>
							</div>
							<div class="row">
	...
	console.log("invoice444="+'${oneJson}');
		...
		$(document).ready(function () {
			$('#cancel_claim').on('click', function () {
				ajax_function_ask_and_close("确认撤销？","statementCancelClaimKp","post",$('#form').serialize(),'撤销成功');
			});	
