        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">	
					  ...
					  <div class="form-group inline-middle">
					    <label >费用单号：</label>
					    <input type="text" name="fy_id" class="form-control search-items" >
					  </div>
					  <div class="form-group input-group inline-small">
					    <label>录入人：</label>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function () {			
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getStatementCostItemPullList",$('#table'));
			});
		...
		$("#batchImport").on('click',function() {
			...
			var item_ids= $.map($table.bootstrapTable('getSelections'), function (row) {
                return {'custom_s_id':row.c_id,'source_no':row.fy_id,'sourece_type':'02','real_money':row.real_money,'total_money':row.total_money,'memo':row.memo};
            });
