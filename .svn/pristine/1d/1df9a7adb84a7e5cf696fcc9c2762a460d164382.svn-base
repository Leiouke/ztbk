			   ...
			   <div class="col-md-12">
			        <div class="row">
				    	<div class="form-group middle-space col-xs-8 not-null">	
	                        ...
	                        <input type="hidden" name="rs_id" value="${param.rs_id}"/>
		                </div>  
				    </div>
			   	    <div class="row">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#save').on('click', function () {
				...
				if(!has_null($("#form"))){
					ajax_function_ask_and_close("确认新增结算单开票明细？","addStatementQuikKpItem","post",$("#form").serialize(),"新增完成！");
				}
			 });
		});
	</script>
