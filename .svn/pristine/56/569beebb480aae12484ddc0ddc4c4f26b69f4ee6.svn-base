...
<html lang="zh-CN">
			...
			<div class="col-md-12">
			   <div class="ibox float-e-margins">
		            <div class="ibox-content search-content">
			            ...
			            <input type="hidden" name="fhsh_family" value=1>
			            <div class="col-xs-12">
				            <div class="row">
	...
	function toDel(inv_id){
	 ...
	 load_sum_list_first("${context}/csu/getTableCollectData",{'queryId':'${queryId}','guidname':'finance_agent_fhsh_guid'},$table);
	var $table = $('#table');
		$(document).ready(function () {
			...
			$('#save').on('click', function () {
				if(!has_null($("#form"))&&!auto_not_matching($("#form"))){
					if($("input[name='f_id']").attr("data-id")==""){
						...
						ajax_function("addFinanceAgentFhsh","post",$('#form').serialize(),'新增成功');
					}
				}				
			 });
			...
			//bootstrap初始化
			initialize_table_editable_footer($table,"getFinanceAgentFhshAddItemList",${tableHeader},queryParams,"#tableTool",550,"editFinanceAgentFhshItem");
			...
			//增加条目layer
			var $add=$("#add");
			button_click_layer_refresh($add,2,"引入申汇明细",'financeAgentFhshItemPull',$table,true,['750px', '580px']);
			//表格配置 layer
			var $config=$("#config");
