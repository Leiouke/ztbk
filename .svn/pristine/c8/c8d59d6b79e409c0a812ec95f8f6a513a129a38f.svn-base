			...
			<div class="col-md-12">
			   <form id="form" class="form-inline">
					<div class="row">
						...
						<div class="form-group middle-space-long-label col-xs-12 not-null">
				           	<label><span style="color:red">*</span>来款单号：</label>
				         	<input type="text" id="payment_no" name="payment_no" class="search-items">
				        </div>
				        <div class="form-group middle-space-long-label col-xs-12">
							<label>用户备注：</label>
							<textarea rows="4" cols="50" name="memo" id ="memo" ></textarea>
						</div>
