...
<html lang="zh-CN">
			...
			<div class="col-md-12">
			   <div class="ibox float-e-margins">
		            <div class="ibox-content search-content">
			            ...
			            <input type="hidden" name="fhsh_family" value=0>
			            <div class="col-xs-12">
				            <div class="row">
	...
	$(document).ready(function () {
			...
			$('#save').on('click', function () {
				if(!has_null($("#form"))&&!auto_not_matching($("#form"))){
					if($("input[name='f_id']").attr("data-id")==""){
						...
						if(same_currency){
							ajax_function("addFinanceFhsh","post",$('#form').serialize(),'新增成功');
						}else{
			...
			//bootstrap初始化
			initialize_table_editable_footer($table,"getFinanceFhshAddItemList",${tableHeader},queryParams,"#tableTool",550,"editFinanceFhshItem");
