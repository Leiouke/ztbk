...
<html lang="zh-CN">
	...
	$(document).ready(function () {
		...
		//bootstrap初始化
 		initialize_table($table,"getSecondaryCustomersList",${tableHeader},queryParams,"#tableTool",400);
		...
		$("#search").on('click',function(){
			...
			search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getSecondaryCustomersList",$('#table'));
		});
