...
<html lang="zh-CN">
        	...
        	<div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  <div class="form-group input-group inline-small">
						    <label >记账年月： 从</label>
						    <input type="text" name="account_month_all_start" id = "account_month_all_start"  class="form-control search-items">
					  ...
					  <div class="form-group input-group inline-small">
						    <label >到</label>
						    <input type="text" name="account_month_all_end" id = "account_month_all_end" class="form-control search-items">
						    <div class="input-group-btn">
	                            <button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown">
	                                <span class="caret"></span>
	                            </button>
	...
	<script type="text/javascript">			
		...
		load_sum_list_first("${context}/csu/getTableCollectData",{'queryId':'${queryId}', 'source_type':'${param.source_type}'});
		$(document).ready(function () {			
			...
			$("#search").on('click',function(){
				 ...
				 if($('#account_month_all_end').val()==""){
					 json_data_list['account_month_all_end'] = '2099.12';
				 }
				 if($('#account_month_all_start').val()==""){
					 json_data_list['account_month_all_start'] = '2099.12';
				 }
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getSaleReportAgencyCollectList",$table);			 
			});
