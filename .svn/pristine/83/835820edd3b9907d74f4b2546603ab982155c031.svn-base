...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			// 填进去计算折扣
			$("input[name='discount_online']").val((invoice.total_money - invoice.kp_money)/invoice.total_money);
			...
			$('#save').on('click', function () {
				...
				if(!has_null($("#form"))){
					ajax_function_ask_and_close("确认修改发票内容明细？","editSaleInvoiceContentItem","post",$("#form").serialize(),"修改完成！");
				}
			 });
		});
	</script>
