...
<html lang="zh-CN">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  ...
					  <div class="form-group inline-small">
					    <label >当前状况：</label>
					    <select name="f_level" class="form-control dictionary">
					    	<option></option>
					    </select>
					  </div>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function () {
		 ...
		 function toDel(f_id){
			 ajax_function_ask_and_refresh("是否删除","deletefactory","post",{'f_id':f_id},"删除成功",$('#table'));
		 }
		 
		 function renderOperator(value,row,index){
			 return "<a onclick=\"toEdit('"+row.f_id+"')\">修改</a>&nbsp;&nbsp;<a onclick=\"toDel('"+row.f_id+"')\">作废</a>";
		 }
