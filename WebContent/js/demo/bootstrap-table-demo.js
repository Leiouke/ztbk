...
(function(document, window, $) {
  ...
  (function() {
    $('#exampleTableEvents').bootstrapTable({
      ...
      columns: [{title: '测试1',field: 'name',align: 'center',checkbox: true,valign: 'middle'},{title: '测试2',field: 'status',align: 'center',valign: 'middle',},{title: '测试3',field: 'participationCounts',align: 'center'},{title: '总人数',field: 'totalCounts',align: 'center'},{title: '开始时间',field: 'startTime',align: 'center',}],
      icons: {
        refresh: 'glyphicon-repeat',
        toggle: 'glyphicon-list-alt',
        columns: 'glyphicon-list'
