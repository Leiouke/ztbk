			...
			<div class="col-md-12">
			   <form id="form" class="form-inline">			        
					...
					<div class="row">
						...
						<div class="form-group small-space col-xs-4">
 				        	<input type="text" name="inc_no" style="display: none;" value = '${inc_no}'>
						</div>
					</div> 
					<div class="row">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#save').on('click', function () {
				if(!has_null($('#form')))
					ajax_function("editQkZdPriodItem","post",$('#form').serialize(),'保存成功');		
			 });

			var period_item = JSON.parse('${oneJson}');
			
			//加载字典数据
			get_dictionary("${context}", period_item);
			
			//填写已有数据
			set_one_info($("#form"), period_item);
