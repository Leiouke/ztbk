...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		function end_function(index, layero){ 
			ajax_function_no_close("returnAgentFinanceFhsh","post",{},null);
		 ...
		 $(document).ready(function () {
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getFinanceAgentFhshManageList",$table);
			 });
			//增加条目layer
			var $add=$("#add");
			button_click_windows_end($add,2,"新增申汇单",'financeAgentFhshAdd',true,['620px', '500px'],end_function);
		 ...
		 function toEdit(fh_id){
			 open_layer_end(2,'编辑申汇单','financeAgentFhshEdit?fh_id='+fh_id,['620px', '580px'],true,end_function);
		 }
		...
		function toOA(fh_id){
			 ajax_function_ask_and_refresh("确认推送OA？","putAgentNpFhshToOa","post",{bill_code:fh_id},'推送成功', $table);
		 }
