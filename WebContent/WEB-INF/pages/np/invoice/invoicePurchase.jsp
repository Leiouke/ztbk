...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		function queryParams(param) {
			...
			json_obj_invoice['inv_id'] = '${param.inv_id}';
		    return json_obj_invoice;
		}
		
		function toDel(cw_type){
			ajax_function_ask_and_refresh("确认删除？","deleteInvoicePurchaseItem","post",{'cw_type':cw_type, 'inv_id': '${param.inv_id}'},"删除成功！",$table);
		}
		...
		$(document).ready(function () {
			...
			initialize_table_editable_footer($table,"getInvoicePurchaseItemList",${tableHeader},queryParams,"#tableTool",550,"updateInvoicePurchaseItem");
			...
			//增加条目layer
			var $add=$("#add");
			button_click_windows_refresh($add,2,"新增财务明细",'invoicePurchaseItemAdd?inv_id=${param.inv_id}',$table,false);
		});
	</script>
</html>