...
<html lang="zh-CN">
		            ...
		            <div class="ibox-content search-content">
			            ...
			            <div class="row">
							  ...
							  <div class="form-group inline-small">
							    <label >红字标志：</label>
							    <select name="is_red" class="form-control dictionary search-items isboolean" disabled>
							    </select>
							  </div>
						</div>
						<div class="row">
							  ...
							  <div class="form-group inline-small">
							    <label >发票类型：</label>
							    <select name="invoice_class" class="form-control dictionary search-items" disabled>
							    	<option></option>
							    </select>
							  </div>
							  <div class="form-group inline-small">
							    <label >发票日期：</label>
							    <input type="text" class="form-control  layer-date search-items date-type"  name="inv_date" id="inv_date" disabled>
							  </div>
							  <div class="form-group inline-small">
							    <label >发票类别：</label>
							    <select name="invoice_family" class="form-control dictionary search-items" disabled>
							    </select>
							  </div>
						</div>
						<div class="row">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#save').on('click', function () {
				if(!has_null($("#form"))){
					if($("input[name='f_id']").attr("data-id")==""){
						...
						ajax_function("editInvoiceTitle","post",$('#form').serialize(),'保存成功');	
					}
				}
			 });			 
			...
			initialize_bsSuggest_agent_client("${context}");
		});
	</script>
</html>