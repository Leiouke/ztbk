...
<html lang="zh-CN">
	...
	<script type="text/javascript">			
		...
		$(document).ready(function () {			
			...
			//bootstrap初始化
			initialize_table($table,"getPoliticalCheckQueryList",${tableHeader},queryParams,"#tableTool",600);
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getPoliticalCheckQueryList",$('#table'));
			});
	    });
		
		function toPoliticalCheck(qk_dh_id, ItemExclusiveCode) {
			open_layer_refresh(2,'详情','itemPoliticalCheck?is_detail=1&qk_dh_id=' + qk_dh_id + '&ItemExclusiveCode=' + ItemExclusiveCode,$table,['750px', '500px'],true);
		}
		
		function renderOperator(value,row,index) {
			var str="";
			str += "<a onclick=\"toPoliticalCheck('" + row.qk_dh_id + "','" + row.ItemExclusiveCode + "')\">详情</a> ";
			return str;
		}
	</script>
</html>