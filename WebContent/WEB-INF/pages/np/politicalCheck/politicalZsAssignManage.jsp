			...
			<div class="col-md-12">
			   <form id="form" class="form-inline">
						<div class="form-group input-group inline-small">
	                        ...
	                        <input type="hidden" name="zpzs_man" class="form-control search-items">
					  </div>
					  <div class="form-group input-group inline-small">
					    <label >期望完成日期：</label>
					...
					<div class="form-group input-group inline-small" style="display:none">
						<label >编号：</label>
						<input type="text" id="ItemExclusiveCode" name="ItemExclusiveCode" class="form-control search-items" >
					</div>
		       </form>
			 </div>
		</div>
...
// 		set_one_info($("#form"), politicalCheckItem);
		...
		$('#ItemExclusiveCode').val('${param.ItemExclusiveCode}');
		
		//移交按钮
		$('#assign').on('click', function () {
			ajax_function("politicalZsAssign","post",$('#form').serialize(),'指派成功');
		 });
	});
