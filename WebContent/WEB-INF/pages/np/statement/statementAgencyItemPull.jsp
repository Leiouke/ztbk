	...
	<div class="row wrapper border-bottom white-bg page-heading">
	        <div class="col-sm-4">
	            ...
	            <ol class="breadcrumb">
	                ...
	                <li>
	                    <a id="" href="statementSubscriptionItemPull">收订业务</a>
	                </li>
	            </ol>
	        </div>
    </div>
	...
	<script type="text/javascript">		
		...
		$("#batchImport").on('click',function() {
			...
			var item_ids= $.map($table.bootstrapTable('getSelections'), function (row) {
                return {'custom_s_id':row.c_id,'source_no':row.so_id,'sourece_type':'01','real_money':row.real_money,'total_money':row.total_money,'memo':''};
            });
