	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getPaymentChargeVerifyManageList",$table);
			});
		 ...
		 function toEdit(pc_id){
			 open_layer_refresh(2,'审核费用支付单','paymentChargeVerify?pc_id='+pc_id,$table,['620px', '580px'],true);
		 }
		 
		 function renderOperator(value,row,index){
			 var str="<a onclick=\"toEdit('" + row.pc_id + "')\">审核</a>";
			 return str;
		 }
	</script>
</html>