         ...
         <div class="ibox float-e-margins">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  ...
					  <div class="form-group inline-small">
					  	<label >支付单状态：</label>
					    <select name="pc_status" data-id-start=3 data-id-end=4 class="form-control dictionary">
					    </select>
					  </div>
					  <div class="form-group inline-small">
					  	<label >发票号：</label>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
		 ...
		 function toEdit(pc_id){
			 open_layer_refresh(2,'付款确认','paymentChargePay?pc_id='+pc_id,$table,['520px', '640px'],false);
		 }
		 
		 function renderOperator(value,row,index){
			var str="<a onclick=\"toEdit('"+row.pc_id+"')\">付款确认</a>";
			return str;
		 }
	</script>
</html>