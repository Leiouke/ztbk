...
<html lang="zh-CN">
	                ...
	                <div class="row row-lg">
	                    <div class="col-sm-12">
                            ...
                            <div class="form-group select-group col-xs-4">
		                  		<label >架号：</label>
		                  		<input name="rack_no" type="text" class="form-input-items" readonly="readonly">
		                	</div>
	...
	<script type="text/javascript">
		...
		function queryParams(param) {
			...
			json_other_out_bound['inventory'] =parent.$("#inventory").val();
		...
		$(document).ready(function () {
			...
			$('#commit').on('click', function () {
				...
				if(!has_null($("#form_verify"))){
					ajax_function("confirmBackIssueOutBound","post",$('#form_verify').serialize(),'验货成功!');
				}
			});
			...
			//bootstrap初始化				
			initialize_table_singleSelect($table,"getConfirmBackIssueOutBoundList",${tableHeader},queryParams,"#tableTool",400);
			...
			$table.bootstrapTable('refreshOptions',{onLoadSuccess: function(data){
				...
				$("input[name='rack_no']").val(row.rack_no);
			}}
			);
