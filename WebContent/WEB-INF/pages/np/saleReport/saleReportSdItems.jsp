...
<html lang="zh-CN">
	...
	<div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content update-content">
	...
	<script type="text/javascript">			
		...
		load_sum_list_first("${context}/csu/getTableCollectData",{'queryId':'${queryId}', 'report_id': '${param.report_id}', 'account_month':'${param.account_month}'});
		$(document).ready(function () {			
			//加载字典数据
			get_dictionary("${context}",null);
			//bootstrap初始化
			initialize_table($table,"getSaleReportSdItemsList",${tableHeader},queryParams,"#tableTool",400);
			...
			$("#search").on('click',function(){
				 ...
				 json_data_list['report_id']='${param.report_id}';
				 json_data_list['account_month'] ='${param.account_month}';
				 search_sum_list("${context}/csu/getTableCollectDataBK",json_data_list,"getSaleReportSdItemsList",$('#table'));
			});
