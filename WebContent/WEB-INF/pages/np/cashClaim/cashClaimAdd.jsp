		...
		<div class="sonpage-body">			
			   ...
			   <div class="col-md-12">
						    ...
						    <div class="row">	                            	
						        ...
						        <div class="form-group small-space col-xs-6" >
						            <label>凭证号：</label>
						            <input type="text" name="pay_certificate" disabled>
						        </div>
						    </div>
						    <div class="row">
                            	<div class="form-group small-space col-xs-6">
			                  		<label >来款日期：</label>
			                        <input type="text" class="layer-date date-type" name="receive_date" id="receive_date" disabled> 
			                	</div>
			                	<div class="form-group small-space col-xs-6">	
			                  		<label>总金额：</label>
			                  		<input type="text" name="receive_money" disabled> 
			                	</div>			                			                	
						    </div>
						    <div class="row">
						    	<div class="form-group small-space col-xs-6">	
			                  		<label>可认领金额：</label>
			                  		<input type="text" name="surplus_money" disabled> 
			                	</div>	
						    </div>						    
						    <div class="row">
                            	<div class="form-group middle-space col-xs-12">
						    ...
						    <div class="row">
							    	<div class="form-group input-group inline-middle small-space col-xs-6 not-null">
									    <label >客户编号：</label>
						    ...
						    <div class="row">
						    	<div class="form-group middle-space col-xs-12">
									    ...
									    <input type="text" name="c_name" class="" disabled>
							    </div>
						    </div>
						    <div class="row">
	...
	$(document).ready(function () {
		...
		$('#save').on('click', function () {
			if(!has_null($("#form"))&&!auto_not_matching($("#form"))){
				ajax_function("addCashClaim","post",$('#form').serialize(),'新增成功');
			}				
		 });
	});
	</script>
