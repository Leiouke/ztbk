	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getAdvancePaymentConfirmManageList",$table);
			 });
	   ...
	   function toConfirm(ap_id){
			ajax_function_ask_and_refresh("是否确认？","advancePaymentConfirm","post",{ap_id:ap_id},'确认成功!', $table);
	   }
		 
	   function renderOperator(value,row,index){
			var str = "";
			if (row.is_confirm == '0') {
				str+="<a onclick=\"toConfirm('"+row.ap_id+"')\">确认</a>";
		    }
			return str;
	   }
	</script>
