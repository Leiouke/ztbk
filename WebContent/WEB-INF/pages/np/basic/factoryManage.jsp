         ...
         <div class="ibox float-e-margins">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  ...
					  <div class="form-group inline-small">
					    <label >审核状态：</label>
					    <select name="factory_status" class="form-control dictionary search-items">
					    	<option></option>
					    </select>
					  </div>
				 </div>
	...
	<script type="text/javascript">
		...
		function queryParams(param) {
		 ...
		 function renderOperator(value,row,index){
			 //console.log(row);
			 var str = "";
			 str += "<a onclick=\"toEdit('"+row.f_id+"')\">修改</a>&nbsp;&nbsp;<a onclick=\"toDel('"+row.f_id+"')\">删除</a>&nbsp;&nbsp;";
			 if (row.status == 0) {
				 str += "<a onclick=\"toCommit('"+row.f_id+"')\">提交</a>";
			 }
			 return str;
		 }
		 ...
		 function toCommit(f_id) {
			 ajax_function_ask_and_refresh("确认提交?","commitFactory","post",{'f_id':f_id},"提交成功",$('#table'));
		 }
