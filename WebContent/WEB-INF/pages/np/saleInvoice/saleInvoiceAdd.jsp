...
<html lang="zh-CN">
	                ...
	                <div class="row row-lg">                    
	                    <div class="col-sm-12">
	                        <div class="btn-group hidden-xs" id="tableTool" role="group">
	                            ...
	                            <!-- <button type="button" class="btn btn-outline btn-default" id="add_so">
	...
	$(document).ready(function () {
		...
		//button_click_layer($("#invoiceAmount"),2,"开票数量","saleInvoiceAmount",true,['750px', '580px']);
		//增加条目layer
		var $add=$("#add");
		button_click_windows_end($add,2,"引入发票明细",'saleInvoiceItemPull',true,['750px', '580px'],end_function);
		//var $add_so=$("#add_so");
		//button_click_windows_end($add_so,2,"引入发票明细-发货单",'saleInvoiceItemPullSo',true,['750px', '580px'],end_function);
		//表格配置 layer
		var $config=$("#config");
