...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		function end_function(index, layero){
		    ...
		    search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getReceiptManageList",$table);
     	}
		function load_table_data_success(data){
			if (data.success){    		
	   			layer.msg("操作成功！");
	   			load_sum_list("${context}/csu/getTableCollectData",{'queryId':'${queryId}','guidname':'sd_guid'},$table);
	    	} else {
		 ...
		 $(document).ready(function () {
			...
			table_column_config_layer($config,2,'表格属性配置','${context}/csu/columnConfig?queryId=${queryId}');
			 ...
			 //initialize_bsSuggest_c_charge_man("${context}");
		 ...
		 function toDetail(c_id){
			 open_layer_end(2,'客户预收管理','oneClientReceiptManage?c_id='+c_id,['620px', '580px'],true,end_function);
		 }
		 
		 function renderOperator(value,row,index){
			 var str="";
			 if(true){
				 str+="<a onclick=\"toDetail('"+row.c_id+"')\">操作</a>";
			 }
			return str;
		 }
	</script>
