                ...
                <div class="panel-body">
                		<div class="row">
                           	<div class="form-group small-space col-xs-12">
		                  		<label >申汇单号：</label>
		                        <input type="text" name="fh_no" disabled> 
		                	</div>
					    </div>
					    <div class="row">
                           	<div class="form-group small-space col-xs-12">
		                  		<label >申汇金额（外币）：</label>
		                        <input type="text" name="fh_money" disabled> 
		                	</div>
					    </div>
						<div class="row">
                           	<div class="form-group small-space col-xs-12">
		                  		<label >付汇金额(人民币)：</label>
		                        <input type="text" name="pay_money" value=0> 
		                	</div>
					    </div>
                        <div class="row">
                           	<div class="form-group small-space col-xs-12">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#save').on('click', function () {
				ajax_function("confirmFh","post",$('#form').serialize(),'完成付汇');	
			 });
		});
	</script>
</html>