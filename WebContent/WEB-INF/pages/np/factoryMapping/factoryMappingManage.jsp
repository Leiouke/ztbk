...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			//bootstrap初始化
			initialize_table($table,"getFactoryMappingManageList",${tableHeader},queryParams,"#tableTool",400);
			$("#search").on('click',function(){
				 var json_data_list=formToJson($("#form_search"));
				 json_data_list['queryId']='${queryId}';
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getFactoryMappingManageList",$table);
			});
			//增加条目layer
			var $add=$("#add");
			button_click_layer_refresh($add,2,"新增关联",'factoryMappingAdd',$table,false,['850px', '400px']);
		...
		function toDel(inc_no) {
			ajax_function_ask_and_refresh("确认删除?","deleteFactoryMapping","post", {'inc_no':inc_no}, "删除成功!", $('#table'));
		}
