...
<html lang="zh-CN">
	...
	<!-- <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <!-- </div>
    		...
    		<div class="sonpage-footer">
			    <button id="export_bd_items" class="btn btn-success" type="button">导出</button>
			</div>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function () {			
			...
			initialize_table_editable($table,"getSectionBdItemList",${tableHeader},queryParams,"#tableTool",600, "editSectionBdItem");
		...
		function toItem(bd_id, qk_id) {
			open_layer_refresh(2,'明细','sectionBdItem99?bd_id='+bd_id + '&qk_id=' + qk_id,$table,['750px', '500px'],true);
		}
		
		function renderOperator(value,row,index) {
			var str="";
			if (row.is_99 == 'T') {
				str += "<a onclick=\"toItem('"+row.bd_id + "','" + row.qk_id + "')\">99明细</a>";
			}
			return str;
	    }
		
		$('#export_bd_items').on('click', function () {
			var href_str="${context}/download/bdItemsExport?";
			href_str += "bd_id=${param.bd_id}";
