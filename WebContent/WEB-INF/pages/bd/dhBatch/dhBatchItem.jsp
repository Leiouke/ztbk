...
<html lang="zh-CN">
	...
	<script type="text/javascript">			
		...
		function queryParams(param) {
			...
			json_obj['limit'] =param.limit;
   	     	...
   	     	json_obj['sortName'] =this.sortName;
   	  		...
   	  		json_obj['batch_id'] ='${param.batch_id}';
   	        return json_obj;
		}
		...
		load_sum_list_first("${context}/csu/getTableCollectData",{'queryId':'${queryId}', 'Batch_no': '${param.batch_id}'});
		$(document).ready(function () {			
			//加载字典数据
			get_dictionary("${context}",null);
			//bootstrap初始化
			initialize_table($table,"getDhBatchItemList",${tableHeader},queryParams,"#tableTool",600);
		...
		function toDel(inv_id){
			ajax_function_ask_and_dosuccess("确认删除？","deleteDhBatchItem","post",{'inv_ids':inv_id},load_table_data_success);
		}
