			            ...
			            <div class="col-xs-11">
				            <div class="row">
								  ...
								  <div class="form-group inline-small not-null">
					    		  		<label >日期：</label>
					    		  		<input type="text" class="form-control  layer-date search-items" name="date" id="date">
					    		  </div>
...
<!-- 							</div> -->
							<div class="row">
								  <div class="form-group inline-small not-null">
								    <label >报订批次：</label>
								    <input type="text" name="bd_pici" class="form-control search-items" value = "1">
								  </div>
								  <div class="form-group inline-large">
								    <label >备注：</label>
	...
	$(document).ready(function () {
		...
		$('#save').on('click', function () {
			if(!has_null($("#form"))){
				ajax_function("addBlQkBd","post",$('#form').serialize(),'保存成功');
			}
		...
		$("#search").on('click',function(){
			if(!$("#date").val()==null||!$("#date").val()==""){
				var json_data_list=formToJson($("#form"));
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getQkFactoryCanBlBdList",$table);
			}else{
				alert("有必填项为空");
			}
		});
...
// 		}});
		...
		if('${f_id}'!=''){
		 ...
		 if('${next_bd_date}'!=''){
			 $("input[name='date']").val('${next_bd_date}');
		 }
// 		 if('${end_time}'!=''){
