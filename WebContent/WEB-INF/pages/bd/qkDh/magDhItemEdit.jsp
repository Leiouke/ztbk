...
<html lang="zh-CN">
		...
		<div class="sonpage-body">			
			   ...
			   <div class="col-md-12">
                            ...
                            <div class="row">
                            	<div class="form-group middle-space col-xs-12">
			                  		<label >实到数：</label>
			                        <input type="text" name="h_amount_dh" > 
			                	</div>
						    </div>
						    <div class="row">	                            	
	...
	$(document).ready(function () {
		...
		//加载字典数据
		var mag_dh_item = dealOneJson('${oneJson}');
		//var cashRegister=JSON.parse('${oneJson}');
		//get_dictionary("${context}",mag_dh_item);
		set_one_info($("#form"),mag_dh_item);
		
		//加载字典数据
		$('#save').on('click', function () {
			if(!has_null($("#form"))&&!auto_not_matching($("#form"))){
				ajax_function("eidtMagDhItemTemp","post",$('#form').serialize(),'修改成功');
			}				
		 });
	});
	</script>
