...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			initialize_table($table,"getOtherInvoiceAddItemList",${tableHeader},queryParams,"#tableTool",550);
		...
		function renderItemMoney(value, row, index) {
			...
			return "<input type='text' style='width: 80%; text-align: right;' class='" + row.cw_type + " input_item_money' data-cw_type='" + row.cw_type
