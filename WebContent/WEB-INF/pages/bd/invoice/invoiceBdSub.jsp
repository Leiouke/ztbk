...
<!-- 					  </div> -->
	...
	<script type="text/javascript">
		...
		function end_function(index, layero){
			...
			search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getQkZdItemPeriodTempList",$table);
     	}
		...
		$(document).ready(function () {
			...
			$("#search").on('click',function(){
				 var json_data_list=formToJson($("#form_search"));
				 json_data_list['queryId']='${queryId}';
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getinvoiceBdSubTempList",$table);
			});
			//增加条目layer
			var $add=$("#add");
			button_click_layer_refresh($add,2,"新增商品刊期",'qkZdItemPeroiodAdd?qk_id='+'${qk_id}',$table,true,['620px', '580px']);
		...
		//编辑页面
		 function toEdit(inc_no){
			 //open_layer_end(2,'编辑开票','qkZdEdit?qk_id='+qk_id,['620px', '580px'],true,end_function);
			 open_layer_refresh(2,'编辑商品刊期','qkZdItemPeroiodEdit?inc_no='+inc_no,$table,['620px', '580px'],true);
		 }	
