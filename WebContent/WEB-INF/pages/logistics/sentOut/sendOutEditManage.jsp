...
<!-- 									    <label >出库类型：</label> -->
<!-- 									    <select name="out_type" data-id-start ="02" data-id-end ="05" class="form-control dictionary search-items"> -->
<!-- 									    </select> -->
<!-- 									  </div> -->
<!-- 								</div> -->
<!-- 								<div> -->
...
<!-- 	    <button id="save" class="btn btn-primary" type="button">保存</button> -->
	...
	function queryParams(param) {
		...
		json_obj_invoice['so_id'] ='${param.so_id}';
...
// 		});
		...
		//bootstrap初始化		
		initialize_table_editable($table,"getSendOutItemList",${tableHeader},queryParams,"#tableTool",550,"editSendOutItem");
