            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  ...
					  <div class="form-group inline-middle">
					    <label >财务编码：</label>
					    <input type="text" name="finance" class="form-control search-items" >
					  </div>
				 </div>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function () {
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getClientList",$('#table'));
			});
			//增加条目layer
			var $add=$("#add");
			button_click_layer_refresh($add,2,"新增客户",'clientAdd',$table,true,['620px', '580px']);
			
			//增加条目layer
			var $download=$("#download");
			button_click_layer_refresh($download,2,"下载益华客户",'clientDownload',$table,false,['800px', '260px']);
		 ...
		 function toEdit(id){
			 open_layer_refresh(2,'编辑客户','clientEdit?c_id='+id,$table,['620px', '580px'],true);
		 }
		 
		 function toDel(c_id){
			 ajax_function_ask_and_refresh("是否删除","deleteClient","post",{'c_ids':c_id},"删除成功",$('#table'));
		 }
		 
		 function renderOperator(value,row,index){
			 return "<a onclick=\"toEdit('"+row.c_id+"')\">修改</a>&nbsp;&nbsp;<a onclick=\"toDel('"+row.c_id+"')\">删除</a>";
		 }
	</script>
</html>