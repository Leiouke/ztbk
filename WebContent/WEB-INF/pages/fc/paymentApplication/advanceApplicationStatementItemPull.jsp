		...
		$(document).ready(function () {
			...
			$('#commit').on('click', function () {
				var send_data= $.map($table.bootstrapTable('getSelections'), function (row) {
	                return {'bill_id':row.pv_id, 'c_real_money':row.c_real_money, 'real_money':row.rmb_real_money};
	            });
			...
			$("#search_pull_items").on('click', function () {
				...
				search_sum_list("${context}/csu/getTableCollectData", json_data_list, "getAdvanceStatementItemPullList", $table);
			});
