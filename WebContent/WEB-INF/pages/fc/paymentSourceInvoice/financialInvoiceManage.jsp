         ...
         <div class="ibox float-e-margins">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">
					  ...
					  <div class="form-group inline-small">
					    <label >发票类型：</label>
					    <select name="fc_invoice_class" class="form-control dictionary" data-id-start="0099" data-id-end="0099">
					    </select>
					  </div>					  
					  <div class="form-group inline-small">
					    <label >发票状态：</label>
					    <select name="fc_invoice_status" class="form-control dictionary" data-id-start="2" data-id-end="2">
					    </select>
					  </div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getFinancialInvoiceManageList",$table);
			});
			...
			table_column_config_layer($config,2,'表格属性配置','${context}/csu/columnConfig?queryId=${queryId}');
			 ...
			 initialize_bsSuggest_fc_user("${context}", "o_id_operator_name", "o_id_operator");      // 放用户信息(业务员)	 
	    });
		
		function toComplement(inv_id) {
			 open_layer_refresh(2,'补充发票信息','financialInvoiceToComplement?inv_id='+inv_id,$table,['520px', '400px'],false);
		}
		 
		function renderOperator(value,row,index){
			var str = '';
			str += "<a onclick=\"toComplement('"+row.inv_id+"')\">补发票</a>";
			return str;
		}
	</script>
</html>