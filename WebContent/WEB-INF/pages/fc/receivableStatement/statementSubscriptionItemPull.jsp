...
<html lang="zh-CN">
	...
	<div class="row wrapper border-bottom white-bg page-heading">
	        <div class="col-sm-4">
	            ...
	            <ol class="breadcrumb">
	                <li>
	                    <a id="" href="statementAgencyItemPull">配送结算</a>
	                </li>
	                <li>
	                    <strong>收订结算</strong>
	                </li>
	...
	<script type="text/javascript">		
		...
		$("#batchImport").on('click',function() {
			...
			var item_ids= $.map($table.bootstrapTable('getSelections'), function (row) {
				return {'c_id':row.c_id,'source_type':'01','source_no':row.zd_id,'real_money':row.real_money,'total_money':row.total_money,'sales_code':row.o_id_operator,'memo':'','op_code':row.o_id_input};
            });
