	...
	<div class="row wrapper border-bottom white-bg page-heading">
	        <div class="col-sm-4">
	            ...
	            <ol class="breadcrumb">
	                ...
	                <li>
	                    <a id="" href="statementSubscriptionItemPull">收订结算</a>
	                </li>
	            </ol>
	        </div>
    </div>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">	
					  ...
					  <div class="form-group inline-middle">
					    <label >月结单号：</label>
					    <input type="text" name="montharrear_id" class="form-control search-items" >
					  </div>
					  ...
					  <div class="form-group inline-small">
					    <label >年月批次：</label>
					    <input type="text" name="months" class="form-control search-items" >
					  </div>
				 </div>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function () {			
			...
			$("#search").on('click',function(){
				 ...
				 search_sum_list("${context}/csu/getTableCollectDataBK",json_data_list,"getStatementAgencyItemPullList",$('#table'));
			});
		...
		$("#batchImport").on('click',function() {
			...
			var item_ids= $.map($table.bootstrapTable('getSelections'), function (row) {
                return {'c_id':row.c_id,'source_type':'02','source_no':row.so_id,'real_money':row.real_money,'total_money':row.total_money,'sales_code':row.c_charge_man,'memo':'','op_code':row.o_id_input};
            });
		...
		function toItem(so_id) {
			open_layer_refresh(2,'分类明细-代销业务','statementAgencyItems?so_id='+so_id,$table,['750px', '500px'],true);
		}
		
		function renderOperator(value,row,index) {
			var str="";
			str += "<a onclick=\"toItem('"+row.so_id+"')\">分类明细</a>";
			return str;
		}
	</script>
</html>