...
<html lang="zh-CN">
	...
	function toDel(kp_id){
		ajax_function_ask_and_dosuccess("确认删除？","deleteClientPayItemItem","post",{'kp_ids':kp_id},load_table_data_success);
	}
		...
		$('#save').on('click', function () {
			if(!has_null($("#form"))){
				if($("input[name='c_id']").attr("data-id")=="") {
					...
					ajax_function("addClientPayItem","post",$('#form').serialize(),'新增成功');
				}
			}
		});
