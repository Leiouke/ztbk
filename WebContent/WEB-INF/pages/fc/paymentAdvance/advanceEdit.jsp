...
<html lang="zh-CN">
			            ...
			            <form id="form" class="form-inline">
				           <div class="col-xs-12">
							...
							<div class="col-xs-12"  style="display:none">
								  <div class="form-group middle-space col-xs-12">
								    <label >pv</label>
								    <input type="text" name="pv_id" class="search-items">
								  </div>
							</div>
						</form>
		            </div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			get_financial_classify_by_dept("${context}", "${sessionScope.defaultRole.dep_org_code}", false, "pv_cw_type", advance.pv_cw_type);
