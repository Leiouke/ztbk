            ...
            <div class="ibox-content search-content">
	            ...
	            <div class="col-xs-11">	
					  ...
					  <div class="form-group input-group inline-small">
					    <label >审批人：</label>
					    <input type="text" name="approval_account_name" class="form-control search-items">
					    <div class="input-group-btn">
                               <button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown">
                                   <span class="caret"></span>
                               </button>
                        ...
                        <input type="hidden" name="approval_account" class="form-control search-items">
					  </div>
...
<!-- 					  </div> -->
	...
	<script type="text/javascript">		
		...
		function end_function(index, layero){
			...
			search_sum_list("${context}/csu/getTableCollectData",json_data_list,"getProcessApprovalList",$('#table'));
     	}
		...
		$(document).ready(function () {
			...
			initialize_table($table,"getProcessApprovalList",${tableHeader},queryParams,"#tableTool",500);
			...
			initialize_bsSuggest_fc_user("${context}", "approval_account_name", "approval_account");      // 放用户信息
			initialize_bsSuggest_fc_user("${context}", "o_id_input_name", "o_id_input");      // 放用户信息
	     });
		 
		 function toApproval(ap_id,flow_id) {
			 open_layer_refresh(2,'审批界面','paymentApplicationApproval?ap_id='+ap_id+'&flow_id='+flow_id,$table,['620px', '580px'],true);
		 }
		 
// 		 function toDeatil(ap_id) {
// 			 open_layer_refresh(2,'付款审批详情','paymentApplicationEdit?ap_id='+ap_id+'&is_detail='+1,$table,['620px', '580px'],true);
// 		 }
		 function toDeatil(ap_id) {
		 ...
		 function renderOperator(value,row,index) {
			...
			var str="";
			str += "<a onclick=\"toDeatil('"+row.ap_id+"')\">详情</a>";
			if(row.is_approval==0){
				str += "&nbsp;&nbsp;<a onclick=\"toApproval('"+row.ap_id+"','"+row.flow_id+"')\">审批</a> ";
			}
			return str;
		 }
	</script>
