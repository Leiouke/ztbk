	...
	<div class="sonpage-body">
			<div class="col-md-12">
			   <form id="form" class="form-inline">
					<div class="row">
						<div class="form-group inline-large not-null">
				           	<label><span style="color:red">*</span>抵扣金额：</label>
				         	<input type="text" id="fee_money" name="fee_money" class="form-control search-items">
				        </div>
				        <div class="form-group inline-large not-null">	
						...
						<div class="form-group inline-large">
				           	<label>发票号：</label>
				         	<input type="text" id="invoice_no" name="invoice_no" class="form-control search-items">
				        </div>
				        <div class="form-group inline-large">
							<label>用户备注：</label>
			  ...
			  <div class="search-group-button">
				<button id="recycle" class="btn btn-danger" type="button" style="display:block;margin:0 auto">提交抵扣</button>
			</div>
		</div>
	</body>
	...
	$(document).ready(function () {
		...
		$('#recycle').on('click', function () {
			if($("#fee_type").val()==0){
				...
				if(!has_null($("#form"))){
					ajax_function_ask_and_close("是否确认抵扣","toFreeRebateDeal","post",$('#form').serialize(),'新增抵扣成功');
				}
			}
		 });
	});
