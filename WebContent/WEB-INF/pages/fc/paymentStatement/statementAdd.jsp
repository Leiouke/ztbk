...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			initialize_table_editable($table,"getStatmentAddItemList",${tableHeader},queryParams,"#tableTool", 550, "editStatementItemBackrate");
		...
		function toEditRate(inc_no, ps_cw_type) {
			open_layer_end(2,'编辑退税税率','statementItemBackrateEdit?inc_no=' + inc_no + '&ps_cw_type=' + ps_cw_type,['420px', '300px'],false,end_function);
		}
