...
<!-- 					  </div> -->
					  ...
					  <div class="form-group inline-small">
					    <label >付款申请状态：</label>
					    <select name="fc_pc_status" class="form-control dictionary search-items" >
					    	<option></option>
					    </select>
					  </div>
				 </div>
...
// 		});
		...
		$(document).ready(function () {
			...
			initialize_table($table,"getPettyCashProcessApprovalList",${tableHeader},queryParams,"#tableTool",500);
		...
		//进入审批界面
		 function toApproval(pc_id,flow_id) {
			 open_layer_refresh(2,'审批界面','toPettyCashProcessApproval?pc_id='+pc_id+'&flow_id='+flow_id,$table,['620px', '580px'],true);
		 }
		 ...
		 function renderOperator(value,row,index) {
			...
			if(row.is_approval==0){
				str += "&nbsp;&nbsp;<a onclick=\"toApproval('"+row.pc_id+"','"+row.flow_id+"')\">审批</a> ";
			}
			return str;
		 }
	</script>
