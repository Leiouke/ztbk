		            ...
		            <div class="ibox-content search-content">
			            ...
			            <div class="col-xs-6">
							<div class="row">
								...
								<div class="form-group inline-large" style = "display:none">
									<label >pc_id：</label>
									<input type="text" id="pc_id" name="pc_id" class="form-control search-items">
								</div>			
							</div>
						 </div>
<!-- 						 <div class="col-xs-6 search-group-button"> -->
...
<!-- 				 		</div> -->
	...
	$(document).ready(function () {
		...
		//bootstrap初始化
		initialize_table($table,"getFcPettyFlowDetialList",${tableHeader},queryParams,"#tableTool",300);
		...
		$('#approve').on('click', function () {
			$('#audit_status').val(0);
			ajax_function_ask_and_close("确认是否通过审核","toPettyCashProcessDeal","post",$('#form').serialize(),'审核通过');
		 });
		
		//不通过按钮
		$('#notapprove').on('click', function () {
			$('#audit_status').val(1);
			ajax_function_ask_and_close("该审批不通过，是否确认","toPettyCashProcessDeal","post",$('#form').serialize(),'审核不通过');
		 });
	});
	</script>
</html>