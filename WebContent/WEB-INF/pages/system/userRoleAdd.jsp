...
<html lang="zh-CN">
                ...
                <!-- <div class="panel-body form-inline"> -->
                            	<div class="row">
	                            	<div class="form-group small-space col-xs-6 not-null">
				                  		<label >用户账号：</label>
				                        <input type="text" name="account" readonly="readonly" value="${param.account}"> 
				                	</div>
							    </div>
							    <div class="row">	                            	
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			//加载字典数据
			get_dictionary("${context}",{'is_default':1});
			
			initialize_bsSuggest_org("${context}","org_name","org_code");

			$('#save').on('click', function () {
				if(!has_null($("#form"))){
					ajax_function_ask_and_close("确认新增用户角色？","addUserRole","post",$("#form").serialize(),"新增完成！");
				}
			});
