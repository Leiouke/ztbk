			...
			<div class="col-md-12">
			   <form id="form" class="form-inline">			        
	            	<div class="row">
				        ...
				        <div class="form-group small-space col-xs-4">
				        	<label >期刊名称：</label>
				        	<input type="text" name="qk_name"  style = "background-color: #e9ecef;" readonly>
				        </div>
					...
					<div class="row">
				        ...
				        <div class="form-group small-space col-xs-4 not-null">
				        	<label >价格类别：</label>
				        	<select name="price_class" id = "price_class" class="dictionary" readonly>
								<option></option>
							</select>
				        </div>
						<div class="form-group small-space col-xs-4 not-null">
...
<!-- 				        </div> -->
					...
					<div class="row">
						...
						<div class="form-group small-space col-xs-4 not-null">
				            <label >开始日期：</label>
							<input name="start_date" id="start_date" type="text" class="form-control" style ="width:68%;background-color: #e9ecef;" readonly>
				        </div>
					</div>
					<div class="row">
				       <div class="form-group small-space col-xs-4">
...
<!-- 				        	<input type="text" name="other_fee1" id = "other_fee1"> -->
<!-- 				        </div> -->
<!-- 				        <div class="form-group small-space col-xs-4"> -->
<!-- 				        	<label >other_fee2：</label> -->
<!-- 				        	<input type="text" name="other_fee2" id = "other_fee2"> -->
<!-- 				      	</div> -->
					</div>	
		       </form>
			 </div>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			var product_price = JSON.parse('${oneJson}');
			
			//加载字典数据
 			get_dictionary("${context}", product_price);
			
			//填写已有数据
			set_one_info($("#form"), product_price);
			...
			$('#save').on('click', function () {
				if(!has_null($('#form'))){
					...
					ajax_function("editProductPrice","post",$('#form').serialize(),'修改成功');		
				}
			 });
